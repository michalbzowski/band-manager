package pl.bzowski.bandmanager.views.uniforms;
...
@PageTitle("Uniforms")
@Route(value = "uniforms/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
@Uses(Icon.class)
public class UniformsView extends Div implements BeforeEnterObserver {
...
//        grid.addColumn(importantRenderer).setHeader("Important").setAutoWidth(true);
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(UniformsView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(UniformsView.class);
            }
        }
    }
